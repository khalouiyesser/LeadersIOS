...
class SignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Set the checkbox to be unchecked initially
    ...
    // MARK: - Validation Functions
        ...
        @IBAction func SingUpAction(_ sender: Any) {
            ...
            if !isTermsAccepted {
                a = 1
                showAlert(message: "You must accept the terms and conditions to sign up.")
                return
            }
    ...
    // Variable to track if the terms are accepted
    ...
    @IBAction func toggleTermsCheckbox(_ sender: UIButton) {
        ...
        // Enable or disable the SignUp button based on checkbox state
        signUpButton.isEnabled = isTermsAccepted
    }

    func updateCheckboxState() {
        // Use system images for checked and unchecked states
        let checkboxImage = isTermsAccepted ? UIImage(systemName: "checkmark.square.fill") : UIImage(systemName: "square")
        
        // Set the image for the checkbox button
        termsCheckbox.setImage(checkboxImage, for: .normal)
        
        // Apply the custom color to the checkbox icon
        termsCheckbox.tintColor = UIColor(red: 19/255, green: 1/255, blue: 96/255, alpha: 1.0)
    }
